...
function prevChar(document, position) {
...
const commandHandler = (name = 'world') => {
    ...
    for (const sel of activeEditor.selections) {
        ...
        (0, Highlighter_1.getHighlighter)(activeEditor).highlight(sel.isEmpty ?
...
function activate(context) {
    ...
    const provider2 = vscode.languages.registerCompletionItemProvider('clyphx', {
